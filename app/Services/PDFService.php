...
class PDFService extends PDF_ImageAlpha
{
    ...
    function Header()
    {
        ...
        if ($this->PageNo() == 1) {
            ...
            $positionX = $this->document['w'] - $this->margins['l'] - $this->margins['r'] - max(strtoupper($this->GetStringWidth($this->l['number'])), strtoupper($this->GetStringWidth($this->l['date'])), strtoupper($this->GetStringWidth($this->l['due'])), strtoupper($this->GetStringWidth($this->l['issuing_date']))) - 35;
            ...
            if ($this->issuingDate) {
                ...
                $this->SetFont($this->font, 'B', 9);
                $this->SetTextColor($this->color[0], $this->color[1], $this->color[2]);
                $this->Cell(32, $lineheight, strtoupper($this->l['issuing_date']) . ':', 0, 0, 'L');
                $this->SetTextColor(50, 50, 50);
                $this->SetFont($this->font, '', 9);
                $this->Cell(0, $lineheight, $this->issuingDate, 0, 1, 'R');
            }
            ...
            if ($this->fromDate) {
                ...
                $this->SetFont($this->font, 'B', 9);
                $this->SetTextColor($this->color[0], $this->color[1], $this->color[2]);
                $this->Cell(32, $lineheight, strtoupper($this->l['from_date']) . ':', 0, 0, 'L');
                $this->SetTextColor(50, 50, 50);
                $this->SetFont($this->font, '', 9);
                $this->Cell(0, $lineheight, $this->fromDate, 0, 1, 'R');
            }
            ...
            if ($this->toDate) {
                ...
                $this->SetFont($this->font, 'B', 9);
                $this->SetTextColor($this->color[0], $this->color[1], $this->color[2]);
                $this->Cell(32, $lineheight, strtoupper($this->l['to_date']) . ':', 0, 0, 'L');
                $this->SetTextColor(50, 50, 50);
                $this->SetFont($this->font, '', 9);
                $this->Cell(0, $lineheight, $this->toDate, 0, 1, 'R');
            }
            ...
            if(!$this->hide_header) {
                ...
                //Address Line 2
                $y = $this->GetY();
                if ($this->from[2] !== '' && $this->from[2] !== null) {
                    $this->MultiCell($width, $lineheight, $this->from[2], 0, 'L', 0);
                }
                $x = $this->GetX();
                $this->SetXY($x + $width, $y);
                if ($this->to[2] !== '' && $this->to[2] !== null) {
                ...
                $y = $this->GetY();
                if ($this->from[6] !== '') {
                    $this->MultiCell($width, $lineheight, $this->from[6], 0, 'L', 0);
                }
                $x = $this->GetX();
                $this->SetXY($x + $width, $y);
                if ($this->to[6] !== '') {
            ...
            //Table header
            if ($this->items & !isset($this->productsEnded)) {
            ...
            //Report header
            if ($this->reportItems & !isset($this->productsEnded)) {
                $width_other = ($this->document['w'] - $this->margins['l'] - $this->margins['r'] - $this->firstColumnWidth - ($this->columns * $this->columnSpacing)) / ($this->columns - 1);
                ...
                $this->Cell($this->firstColumn, 10, strtoupper(isset($this->headerTitle) ? $this->headerTitle : 'Header'), 0, 0, 'L', 1);
                $this->Cell($this->columnSpacing, 10, '', 0, 0, 'L', 0);
                $this->Cell($width_other, 10, strtoupper($this->l['total']), 0, 0, 'C', 1);
                $this->Ln();
            }
